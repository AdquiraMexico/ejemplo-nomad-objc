...
@interface DownPicker : UIControl<UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, DownPickerDelegate>
{
...
@property (nonatomic, weak) id <DownPickerDelegate> delegate;
